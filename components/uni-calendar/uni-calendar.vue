<template>
	<view class="uni-calendar" :class="{
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			...
			<view class="uni-calendar__header" :class="{
					'fui-line-l fui-line-r': border
				}">
				<view class="uni-calendar__back-top">
			...
			<view class="uni-calendar__box"  :class="{
					'fui-line-b': border
				}">
				<view v-if="showMonth" class="uni-calendar__box-bg">
					<text class="uni-calendar__box-bg-text">{{nowDate.month}}</text>
				</view>
				<view class="uni-calendar__weeks" :class="{
						'fui-line-l fui-line-r': border
					}">
				...
				<view class="uni-calendar__weeks" :class="{
					'fui-line-t fui-line-l': border
				}" v-for="(item,weekIndex) in weeks" :key="weekIndex">
					<view class="uni-calendar__weeks-item" :class="{
					'fui-line-r': border
				}" v-for="(weeks,weeksIndex) in item" :key="weeksIndex">
