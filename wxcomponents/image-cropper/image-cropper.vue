<template>
<uni-shadow-root class="image-cropper-image-cropper"><view class="image-cropper" @touchmove.stop.prevent="_preventTouchMove">
    <view class="main" @touchend="_cutTouchEnd" @touchstart="_cutTouchStart" @touchmove="_cutTouchMove" @click="_click">
        <view class="content">
...
global['__wxRoute'] = 'image-cropper/image-cropper'
Component({
    properties: {
        /**     
         * 图片路径
...
export default global['__wxComponents']['image-cropper/image-cropper']
</script>
